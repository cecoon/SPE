...
import matchModel.util.ItemPO;
import matchModel.Item;
import matchModel.util.PersonPO;
...
public class PersonPO extends PatternObject<PersonPO, Person>
{
   ...
   public PersonPO(){
      newInstance(matchModel.util.CreatorCreator.createIdMap("PatternObjectType"));
   }
   ...
   public PersonPO(Person... hostGraphObject) {
      ...
      newInstance(matchModel.util.CreatorCreator.createIdMap("PatternObjectType"), hostGraphObject);
   }
